<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phpStudy\WWW\prison\public/../application/admin\view\index\goods_up.html";i:1496308995;s:72:"D:\phpStudy\WWW\prison\public/../application/admin\view\public\head.html";i:1496286527;s:72:"D:\phpStudy\WWW\prison\public/../application/admin\view\public\foot.html";i:1496279236;}*/ ?>
<!doctype html>
<html>
        ...
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" method="post" action="<?php echo url('Index/goods_do_up'); ?>" enctype="multipart/form-data">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">商品名称 <span class="tpl-form-line-small-title">Title</span></label>
                            <div class="am-u-sm-9">
                                <input type="hidden" name="id" class="tpl-form-input" value="<?php echo $info['Id']; ?>"/>
                                <input type="text" class="tpl-form-input" value="<?php echo $info['goodsname']; ?>" name="goodsname" id="user-name" placeholder="请输入商品名称">
                                <small>请输入商品名称。</small>
                            </div>
                        </div>
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" value="<?php echo $info['price']; ?>" name="price" id="user-name" placeholder="请输入价格">
                                <small>请填写价格。</small>
                            </div>
                        </div>
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input"  value="<?php echo $info['score']; ?>" name="score" id="user-name" placeholder="请输入库存">
                                <small>请填写库存。</small>
                            </div>
                        </div>
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file">
                                    <div class="tpl-form-file-img">
                                        <img id="preview" style="max-height: 200px; width: auto;" src="/Uploads/<?php echo $info['photo']; ?>" alt="">
                                    </div>
                                    <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                        <i class="am-icon-cloud-upload"></i> 添加封面图片</button>
                                    <input id="doc-form-file" value="<?php echo $info['score']; ?>" name="photo" type="file" multiple>
                                </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea name="intro" class="" rows="10" id="user-intro" placeholder="请输入商品简介"><?php echo $info['intro']; ?></textarea>
                            </div>
                        </div>
