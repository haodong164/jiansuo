<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\phpstudy\WWW\prison\public/../application/admin\view\index\index.html";i:1496229452;s:74:"F:\phpstudy\WWW\prison\public/../application/admin\view\public\header.html";i:1496229949;s:72:"F:\phpstudy\WWW\prison\public/../application/admin\view\public\left.html";i:1496278458;}*/ ?>
<!doctype html>
<html>
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    ...
                    <ul class="am-dropdown-content tpl-dropdown-content">
                      ...
                      <img src="__STATIC__assets/img/user02.png" alt=""> </span>
                                <span class="tpl-dropdown-content-subject">
                      <span class="tpl-dropdown-content-from">大狗</span>
                            ...
                            <a href="#" class="tpl-dropdown-content-message">
                                <span class="tpl-dropdown-content-photo">
                      <img src="__STATIC__assets/img/user03.png" alt=""> </span>
                                <span class="tpl-dropdown-content-subject">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                        <span class="tpl-header-list-user-nick"></span><span class="tpl-header-list-user-ico"> <img src=""></span>
                    </a>
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="javascript:" class="active">
                                    ...
                                    <span class="js-append-tab" data_id="<?php echo url('Index/name_user'); ?>">用户列表</span>
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                               ...
                               <a href="javascript:" class="active">
									<i class="am-icon-angle-right"></i>
									<span class="js-append-tab" data_id="<?php echo url('Index/laws_list'); ?>">法律法规管理列表</span>
									<i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
								</a>
								<a href="javascript:" class="active">
									<i class="am-icon-angle-right"></i>
									<span class="js-append-tab" data_id="<?php echo url('Index/relulist'); ?>">规则列表</span>
									<i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
								</a>
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                ...
                                <a href="javascript:" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span class="js-append-tab" data_id="<?php echo url('Index/notice'); ?>">公告添加</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
                                <a href="javascript:" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span class="js-append-tab" data_id="<?php echo url('Index/notice_list'); ?>">公告列表</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                ...
                                <a href="javascript:" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span class="js-append-tab" data_id="<?php echo url('Index/userlist'); ?>">系统用户的列表</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
                                <a href="javascript:" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span class="js-append-tab" data_id="<?php echo url('Index/rolelist'); ?>">角色列表</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
                                <a href="javascript:" class="active">
                                    <i class="am-icon-angle-right"></i>
