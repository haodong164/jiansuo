<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpStudy\WWW\prison\public/../application/admin\view\login\index.html";i:1496303811;}*/ ?>
<!doctype html>
<html>
...
<div class="am-g myapp-login">
    <div class="myapp-login-logo-block  tpl-login-max">
        <div class="myapp-login-logo-text">
            <div class="myapp-login-logo-text">
                Sunshine Prison  <span> Login</span> <i class="am-icon-skyatlas"></i>
            </div>
        </div>
