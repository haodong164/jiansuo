<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\prison\public/../application/admin\view\index\set_add.html";i:1496578159;s:72:"D:\phpStudy\WWW\prison\public/../application/admin\view\public\head.html";i:1496286527;s:72:"D:\phpStudy\WWW\prison\public/../application/admin\view\public\foot.html";i:1496279236;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="<?php echo url('Index/set_do_add'); ?>" >
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">用户组名称 / GroupName</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="title" id="user-name" placeholder="姓名 / Name">
                                        <small>输入用户组名称</small>
                                    </div>
                                </div>
                                <div class="am-form-group">
